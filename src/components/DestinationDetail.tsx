...
import { MapPin, Calendar, Clock, Star, IndianRupee, Camera } from 'lucide-react';
...
const DestinationDetail = () => {
  ...
  const similarDestinations = destination ? 
    destinations
      .filter(d => 
        d.id !== id && 
        (d.city === destination.city || d.state === destination.state)
      )
      .slice(0, 3) 
    : [];
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="relative h-[300px] md:h-[400px] mb-8 rounded-lg overflow-hidden shadow-md">
        <img 
          src={ensureValidImageUrl(destination.image)}
        ...
        <div className="space-y-6">
          ...
          <Card className="sticky top-6">
            <CardContent className="p-6 space-y-4">
              ...
              {destination.price && destination.price.adult === 0 ? (
                ...
                <div className="space-y-4">
                  ...
                  {destination.price && destination.price.child > 0 && (
                    <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                      <div className="flex items-center justify-between">
                        <div>
                  ...
                  {destination.price && destination.price.foreigner && destination.price.foreigner > 0 && (
