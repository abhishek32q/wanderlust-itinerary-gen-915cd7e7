        ...
        <div className="container mx-auto px-4 sm:px-6 py-4">
          <div className="flex justify-between items-center">
            <Link to="/" className="flex items-center">
              <h1 className="text-2xl font-bold text-primary">ZenWay Travels</h1>
            </Link>
            ...
            {isMobile ? (
              ...
              <nav className="hidden md:flex items-center gap-6">
                ...
                <Link 
                  ...
                  className={cn(
                    "font-medium",
                    isActive('/destinations') ? "text-primary" : "text-gray-600 hover:text-gray-900"
                  )}
                >
                  Destinations
                </Link>
                <Link 
                  ...
                  className={cn(
                    "font-medium",
                    isActive('/trip-planner') ? "text-primary" : "text-gray-600 hover:text-gray-900"
                  )}
                >
                  Plan Trip
                </Link>
                <Link 
                  ...
                  className={cn(
                    "font-medium",
                    isActive('/profile') ? "text-primary" : "text-gray-600 hover:text-gray-900"
                  )}
                >
                  Profile
                </Link>
      ...
      <footer className="bg-gray-800 text-gray-200">
        <div className="container mx-auto px-4 py-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="font-bold text-lg mb-4">ZenWay Travels</h3>
              <p className="text-gray-400">Discover the world with us. Experience the best travel destinations with expert guides and personalized plans.</p>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/trip-planner" className="text-gray-400 hover:text-white">Plan Trip</Link></li>
            ...
            <div>
              ...
              <p className="text-gray-400">Email: info@zenwaytravels.com</p>
